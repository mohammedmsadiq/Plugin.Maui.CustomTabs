...
public sealed class HomePageViewModel : BindableBase
{
    ...
    /// <summary>
    /// Command to select the messages tab via Prism navigation.
    /// </summary>
    public DelegateCommand SelectMessagesTabCommand { get; }
    ...
    public HomePageViewModel(INavigationService navigationService)
    {
        ...
        SelectMessagesTabCommand = new DelegateCommand(async () =>
            await SafeExecution.RunAsync(
                () => SelectTabAsync("messages"),
                "HomePageViewModel.SelectMessagesTabCommand"));
